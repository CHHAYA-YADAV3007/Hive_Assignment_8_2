...
/**
 * This class will create a custome HIVE UDF where evaluate method of UDF class is invoked for each record of HIVE UDF.
 * This program accepts two arguments and concatenates the array elements of field value alongwith separator which is passed as a first argument.
 * 
 * Dated : 08-OCT-2016.
 * 
 * @author chhaya YADAV
